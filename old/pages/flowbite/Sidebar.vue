<template>
    <div>
        <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 !bg-gray-800 !border-gray-700">
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow !bg-gray-700 !divide-gray-600" id="dropdown-user">
                        ...
                        <ul class="py-1" role="none">
                            <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 !text-gray-300 hover:!bg-gray-600 hover:!text-white" role="menuitem">Dashboard</a>
                            </li>
                            <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 !text-gray-300 hover:!bg-gray-600 hover:!text-white" role="menuitem">Settings</a>
                            </li>
                            <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 !text-gray-300 hover:!bg-gray-600 hover:!text-white" role="menuitem">Earnings</a>
                            </li>
                            <li>
            ...
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg !border-gray-700 mt-14">
