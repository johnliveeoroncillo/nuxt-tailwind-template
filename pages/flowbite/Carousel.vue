...
onMounted(() => {
    ...
    const options = {
        ...
        indicators: {
            activeClasses: 'bg-white !bg-gray-800',
            inactiveClasses: 'bg-white/50 !bg-gray-800/50 hover:bg-white hover:!bg-gray-800',
            items: [
                {
                    position: 0,
        ...
        <div class="relative">
            ...
            <div class="relative h-56 overflow-hidden rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                ...
                <div id="carousel-item-1" class="hidden duration-700 ease-in-out">
                    <span class="absolute text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 sm:text-3xl !text-gray-800">First Slide</span>
            ...
            <button id="data-carousel-prev" type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white/30 !bg-gray-800/30 group-hover:bg-white/50 !group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white !group-focus:ring-gray-800/70 group-focus:outline-none">
                    <svg class="w-5 h-5 text-white sm:w-6 sm:h-6 !text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
            ...
            <button id="data-carousel-next" type="button" class="absolute top-0 right-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white/30 !bg-gray-800/30 group-hover:bg-white/50 !group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white !group-focus:ring-gray-800/70 group-focus:outline-none">
                    <svg class="w-5 h-5 text-white sm:w-6 sm:h-6 !text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
