  ...
  <div class="max-w-2xl p-4 mx-auto">
        <div id="dialParent" class="fixed right-6 bottom-6 group">
            <div id="dialContent" class="flex flex-col items-center hidden mb-4 space-y-2">
                ...
                <div id="tooltip-share" role="tooltip" class="absolute z-10 invisible inline-block w-auto px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip !bg-gray-700">
                    Share
                ...
                <div id="tooltip-print" role="tooltip" class="absolute z-10 invisible inline-block w-auto px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip !bg-gray-700">
                    Print
                    <div class="tooltip-arrow" data-popper-arrow></div>
                </div>
            ...
            <button type="button" id="dialButton" aria-controls="speed-dial-menu-default" aria-expanded="false" class="flex items-center justify-center text-white bg-blue-700 rounded-full w-14 h-14 hover:bg-blue-800 !bg-blue-600 hover:!bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none focus:!ring-blue-800">
