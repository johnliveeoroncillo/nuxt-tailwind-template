...
<template>
    <div>
        <div class="flex justify-center p-4">
            <button id="button" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 !bg-blue-600 hover:!bg-blue-700 focus:outline-none focus:!ring-blue-800">Show modal</button>
        </div>
            ...
            <div class="relative w-full h-full max-w-2xl md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow !bg-gray-700">
                    ...
                    <div class="flex items-start justify-between p-5 border-b rounded-t !border-gray-600">
                        <h3 class="text-xl font-semibold text-gray-900 lg:text-2xl !text-white">
                            Terms of Service
                        </h3>
                        <button id="closeButton" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center hover:!bg-gray-600 hover:!text-white">
